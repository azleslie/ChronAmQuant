...
```{r, echo=FALSE}
# don't run this code
hits <- read.csv("jack_london_sn85035720.csv") %>% select(-X)
```
...
```{r, echo=FALSE}
# don't run this code
hits <- read.csv("andrew_carnegie_sn85035720.csv") %>% select(-X)
```
...
```{r, echo=FALSE}
# don't run this code
hits <- read.csv("russo_japanese_war_sn85035720.csv") %>% select(-X)
```
