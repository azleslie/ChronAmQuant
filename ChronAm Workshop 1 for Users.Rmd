...
```{r}
unlink(Sys.glob(file.path("/Users/ref/Downloads/sn85035720/*/*/*/*/*", "*.xml")))
```
...
years <- list.files("/Users/ref/Downloads/sn85035720")
# a list of each year we have data for

for (k in seq_along(years)) {
  # for each year of data, we're going to...
  
  months <- list.files(paste("/Users/ref/Downloads/sn85035720/", years[k], sep=""))
...
for (k in seq_along(years)) {
  ...
  for (j in seq_along(months)) {
    days <- list.files(paste("/Users/ref/Downloads/sn85035720/", 
...
for (k in seq_along(years)) {
  ...
  for (j in seq_along(months)) {
    ...
    for (i in seq_along(days)) {
      pages <- list.files(Sys.glob(paste("/Users/ref/Downloads/sn85035720/", 
...
searchfun <- function (year, month, day, page) { 
  ...
  file_path <- paste("/Users/ref/Downloads/sn85035720/", 
  ...
  tot_pg <- length(list.files(Sys.glob(paste("/Users/ref/Downloads/sn85035720/", 
                     year, "/", month, "/", day, "/*", sep=""))))
