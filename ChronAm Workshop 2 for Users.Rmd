...
In order to save ourselves the time of re-downloading on the shared lab computers we're using for this workshop, I've saved the results as a .csv file, which we can read in now instead.
